...
# Reception (4,4) and Pharmacy (14,4) are both in the top row, separated by
# a room-free corridor gap around x in [8,10]. The route must not pass
# through Pharmacy's or Reception's own interior along the way (other than
# its own start/end point).
